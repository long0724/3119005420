...
public class PaperCheckMainTest {
    ...
    @Test
    public void AddTest() { //原文件与add文件比较
    ...
    @Test
    public void DelTest() {//原文件与del文件比较
        String str0 = IoUtils.read("C:/tests/org.txt");
    ...
    @Test
    public void Dis_1Test() {//原文件与dis_1文件比较
        String str0 = IoUtils.read("C:/tests/org.txt");
    ...
    @Test
    public void Dis_10Test() {//原文件与dis_10文件比较
        String str0 = IoUtils.read("C:/tests/org.txt");
    ...
    @Test
    public void Dis_15Test() {//原文件与dis_15文件比较
        String str0 = IoUtils.read("C:/tests/org.txt");
